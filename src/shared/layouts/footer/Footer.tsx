...
export default function Footer() {
  return (
    <footer className="relative mx-auto flex w-full flex-col justify-between overflow-hidden bg-[#2563EB] px-[83px] pt-[120px] pb-[60px] text-white">
      ...
      <div className="flex w-full items-start justify-between">
        ...
        <div className="flex h-[160px] w-[421px] flex-col justify-between gap-[24px]">
          <div>
            <h2 className="text-[28px] leading-[1.2] font-normal ">
                Instant <span className=" font-geist-pixel-circle">
