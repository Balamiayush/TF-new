...
export default function ModularBlocksSection() {
  ...
  useGSAP(
    () => {
      ...
      // 2. Continuous Line Fill Animation
  ...
  return (
    <div ref={sectionRef} className="relative min-h-screen w-full py-[120px]">
      <LayoutWrapper>
        {/* Header */}
        <div className="flex w-full justify-between">
          <h3 className="max-w-[613px] text-[42px] leading-[110%] font-medium tracking-[-0.3px]">
            Modular blocks for managing risk in the customer journey.
          </h3>
          <div className="flex flex-col items-start gap-4">
            <p className="max-w-[475px] text-[16px] leading-[130%] tracking-[-0.4px] text-slate-600">
        ...
        <div className="relative mt-[84px] flex items-start justify-between gap-12">
          <div className="relative flex flex-1 flex-col">
            <div className="absolute top-[15px] bottom-[15px] left-[14px] w-[2px] -translate-x-1/2 overflow-hidden">
              <div
                ref={lineFillRef}
                className="relative h-full w-full origin-top scale-y-0 before:absolute before:inset-y-0 before:left-0 before:w-[1px] before:bg-[linear-gradient(180deg,rgba(255,255,255,0.28)_0%,#E4EAF2_2.6%,#E4EAF2_97.42%,#FFFFFF_100%)] after:absolute after:inset-y-0 after:right-0 after:w-[1px] after:bg-[linear-gradient(180deg,rgba(255,255,255,0.28)_0%,#E4EAF2_2.6%,#E4EAF2_97.42%,#FFFFFF_100%)]"
              />
            </div>

            {/* STEPS LIST */}
            <div className="steps-container flex flex-col gap-[120px] mt-40">
              {STEPS_DATA.map((step, index) => {
                ...
                return (
                  <div
                    key={step.id}
                    className="step-block flex gap-8 transition-opacity duration-500 ease-out"
                    style={{ opacity: isActive ? 1 : 0.35 }}
                  >
                    {/* CENTERED STEP BADGE */}
                    <div className="relative z-10 flex flex-col items-center">
                      <div
                        className={`flex h-[30px] w-[30px] items-center justify-center rounded-sm border-[0.73px] transition-all duration-300 ${
                          isActive
                    ...
                    {/* STEP TEXT CONTENT */}
                    <div className="flex max-w-[500px] flex-col gap-6 pt-0.5">
                      <p className="text-[16px] leading-[110%] font-medium text-slate-900">
                        {step.tag}
                      </p>
                      <h4 className="text-[34px] leading-[110%] font-normal tracking-[-0.3px] text-slate-900">
                        {step.title}
                      </h4>
                      <p className="text-[14px] leading-[130%] text-slate-600">
                        {step.description}
                      </p>
          ...
          <div className="sticky top-[120px] h-[580px] w-full max-w-[677px] overflow-hidden rounded-2xl border border-slate-200/80 bg-white">
