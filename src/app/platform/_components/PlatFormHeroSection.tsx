...
export default function PlatFormHeroSection() {
  ...
  <LayoutWrapper className="relative z-100">
    <div className="flex flex-col gap-10  md:gap-16 lg:gap-[84px]">
      <div>
        <h1 className="max-w-[558px] text-4xl font-medium leading-[1.05] tracking-[-0.3px]  md:text-6xl lg:text-[64px]">
          Approve the right customer at scale
        </h1>
        <p className="text-alpha-light-900 mt-4 max-w-[450px] text-sm tracking-[-0.4px] ">
