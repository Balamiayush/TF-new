    ...
    <div key={category.name} className="group shrink-0">
      <Button variant="tertiary">
        ...
        <div className="blog-cards-container mt-12 grid w-full grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {/* Row 1: Featured Left */}
          <div className="group flex cursor-pointer flex-col justify-between rounded-[8px] border border-slate-200 bg-white p-2 md:col-span-2 md:flex-row md:gap-6">
          ...
          <div className="group flex cursor-pointer flex-col justify-between rounded-[8px] border border-slate-200 bg-white p-4  transition-all duration-300  md:col-span-2 md:flex-row  md:gap-6">
